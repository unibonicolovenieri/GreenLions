...
const DATI = {
  ...
  rosa_gestione: [
    { id: 1, nome: 'Thomas', cognome: 'Ferrari', numero: 1, ruolo: 'giocatore', e_giocatore: true,
      tessera_anspi: true, tessera_csi: false, tessera_anspi_numero: '00123-AB', tessera_csi_numero: null,
      tessera_anspi_scadenza: '2027-12-31', tessera_csi_scadenza: null, visita_scadenza: '2099-01-01',
      data_nascita: '1998-04-12', documento_tipo: "Carta d'identità", documento_numero: 'CA1234567',
      email: 't@e.it', telefono: '331' },
    { id: 2, nome: 'Nicolò', cognome: 'Venieri', numero: 8, ruolo: 'giocatore', e_giocatore: true,
      tessera_anspi: false, tessera_csi: true, tessera_anspi_numero: null, tessera_csi_numero: 'CSI/9910',
      tessera_anspi_scadenza: null, tessera_csi_scadenza: null, visita_scadenza: '2099-01-01',
      data_nascita: null, documento_tipo: null, documento_numero: null,
      email: 'n@e.it', telefono: '332' },
    { id: 4, nome: 'Marco', cognome: 'Bianchi', numero: 10, ruolo: 'allenatore', e_giocatore: false,
      tessera_anspi: true, tessera_csi: false, tessera_anspi_numero: 'ANSPI-777', tessera_csi_numero: null,
      tessera_anspi_scadenza: '2027-12-31', tessera_csi_scadenza: null, visita_scadenza: null,
      data_nascita: '1975-02-20', documento_tipo: 'Passaporto', documento_numero: 'PA9', email: 'm@e.it', telefono: '333' },
  ],
